...
const names=['openRunDuplicate','duplicateCurrentRun','editRunPlan','saveRunPlan','canEditRun','runSummaryCardHtml','runPlansHtml','coachEventRunViewerHtml','runView','currentRunFormState','runBuilderStage'];
