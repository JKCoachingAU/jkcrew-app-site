...
const names=['runBuilderStage','bindRunTimingControls','runSegmentEditorHtml','paintRunSegmentSelection','selectRunSegment','runTimeBudget','runTimeBudgetHtml','paintRunTimeBudget','runTiming','runPlaybackDefaultSeconds','runTimingRowHtml','runTimingEditorHtml','runBuilderTrickEditorHtml','runPointColor','updateRunTiming','updateRunFinalType','updateRunBuilderTrick','runMapHtml','runView','runRouteSvg','runPathBetween','bindRunBuilderActions'];
