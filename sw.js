...
const RELEASE_VERSION = "2.14.138";
const CACHE_NAME = `${CACHE_PREFIX}v${RELEASE_VERSION}`;
const APP_SHELL = [
  "./vendor/supabase-2.116.0.min.js",
  "./",
  "./index.html",
  "./styles.css?v=2.14.138",
  "./app.js?v=2.14.138",
  "./daily-completion.js?v=2.14.138",
  "./daily-tier-two.js?v=2.14.138",
  "./daily-tier-two.css?v=2.14.138",
  "./other-things-landed.js?v=2.14.138",
  "./other-things-landed.css?v=2.14.138",
  "./live-run-sync.js?v=2.14.138",
  "./live-run-call.js?v=2.14.138",
  "./live-run-call.css?v=2.14.138",
  "./daily-completion.css?v=2.14.138",
  "./progress-sharing.js?v=2.14.138",
  "./progress-sharing.css?v=2.14.138",
  "./battle-rematches.js?v=2.14.138",
  "./battle-rematches.css?v=2.14.138",
  "./bike-parts-catalog.js?v=2.14.138",
  "./bike-config.js?v=2.14.138",
  "./bike-seat-designs.js?v=2.14.138",
  "./bike-photo-masks.js?v=2.14.138",
  "./bike-renderer.js?v=2.14.138",
  "./bike-preview.js?v=2.14.138",
  "./bike-preview.css?v=2.14.138",
  "./bike-three.js?v=2.14.138",
  "./bike-garage.js?v=2.14.138",
  "./bike-garage.css?v=2.14.138",
  "./manifest.webmanifest?v=2.14.138",
  ...
  "./icons/badges/prestige-01.png?v=2.14.138",
];
...
const BIKE_3D_ASSETS = [
  "./bike-three-model.js?v=2.14.138",
