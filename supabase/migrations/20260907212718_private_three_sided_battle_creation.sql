-- Keep privileged battle creation outside the exposed API schema.
...
as $$ select private.create_three_sided_rider_battle(p_team_one,p_team_two,p_team_three,p_duration_days,p_reward_points); $$;
