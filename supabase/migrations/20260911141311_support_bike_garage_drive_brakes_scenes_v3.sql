-- Accept drive side, independent front braking and cosmetic photo scenes.
-- V1 and V2 keep their exact keys/options; V3 adds two required enum fields.
-- No saved rows are rewritten. RPCs, RLS, grants and revision rules are unchanged.
